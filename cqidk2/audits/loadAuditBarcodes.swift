...
class loadAuditBarcodes: UIViewController {
    ...
    //Roll up all standard barcode lookups into one
...
//        let google_sheet_url_strings = ["https://sheet.best/api/sheets/4b453c9b-21ec-4dd3-ad40-909f239a4540"]
        
        
        //Loop through each google sheet and store all barcodes
        for google_sheet_url in google_sheet_url_strings {
